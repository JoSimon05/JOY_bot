...
module.exports = {
    ...
    data: {
        name: "skip",
        description: "Passa al brano successivo"
    },
    ...
    execute(interaction, bot) {
        ...
        if (queue.autoplay || queue.songs.length > 1) {
            ...
            interaction.reply({ content: "Brano successivo..." })

        } else {
            return interaction.reply({ content: "ERRORE: nessun brano in coda", ephemeral: true })
        }
    }
}